...
namespace Weechat
{
    ...
    public class Buffer
    {
        ...
        public Buffer(string name, [CCode (delegate_target_pos = 2.1)] BufferInputCallback? input_callback = null, [CCode (delegate_target_pos = 3.1)] BufferCloseCallback? close_callback = null);
